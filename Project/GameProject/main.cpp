...
void Init(void)
{
	...
	//ボタンの設定
	CInput::Init();
	CInput::SetButton(0, CInput::eButton1, 'D');
	...
	ADD_RESOURCE("Hit", CImage::CreateImage("Image/Hit.png"));
	ADD_RESOURCE("Notes", CImage::CreateImage("Image/Notes_Bear.png"));
	ADD_RESOURCE("Hit", CImage::CreateImage("Image/Hit.png"));
	ADD_RESOURCE("SelectSceme_backGround", CImage::CreateImage("Image/SetectScene_BackGround.png"));
	ADD_RESOURCE("SelectScene_parts", CImage::CreateImage("Image/SetectScene_parts.png"));
	ADD_RESOURCE("Number", CImage::CreateImage("Image/Number.png"));
	////動画の読み込み
	//video = new CVideo("Movie/R4ゲーム課題②.mp4");
	////動画の再生
	//video->Play();
	SOUND("Pokahoshi")->Load("Sound/BGM/Pokapokanohoshi.wav");
	SOUND("Roki")->Load("Sound/BGM/Roki.wav");
	SOUND("Tap")->Load("Sound/SE/Tap.wav",3);

	

	Base::Add(new Title());
	/*video = new CVideo("Movie/Pokahoshi.mp4");
	video->Play();*/
}
